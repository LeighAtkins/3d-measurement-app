...
export default function CompanyLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Verify company subdomain match
      if (payload.company?.subdomain !== formData.subdomain) {
          ...
          <div className="rounded-md shadow-sm space-y-4">
            <div>
              ...
              >
                ...
                <option value="demo">Demo Company</option>
                <option value="test">Test Company</option>
              </select>
            </div>
          ...
          <div className="text-center">
            <div className="text-sm text-gray-600">
              ...
              <div className="bg-gray-100 rounded-md p-3 text-left">
                ...
                <p><strong>Subdomain:</strong> acme</p>
              </div>
            </div>
          </div>
        </form>
